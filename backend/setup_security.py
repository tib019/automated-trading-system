...
def fix_file_permissions():
    ...
    files_to_secure = [
        (in_base('.master_key'), 0o600),
        (in_base('security.db'), 0o600),
        (in_base('trading_data.db'), 0o600),
        (in_base('security.log'), 0o600),
        (in_base('.env'), 0o600)
    ]
...
"""
    ...
    policy_file = in_base('SECURITY_POLICY.md')
...
"""
    ...
    checklist_file = in_base('SECURITY_CHECKLIST.md')
...
LOG_FILE=in_base("security_monitor.log")
DATE=$(date)
...
"""
    ...
    monitor_file = in_base('security_monitor.sh')
